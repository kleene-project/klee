...
T = TypeVar("T", bound="DeploymentConfigContainersItem")


@_attrs_define
class DeploymentConfigContainersItem:
    """
    Attributes:
        ...
        user (Union[Unset, None, str]): User that executes the command (cmd).
            ...
            This parameter will be overwritten by the jail parameter `exec.jail_user` if it is set.
             Default: ''.
        endpoints (Union[Unset, List['EndPointConfig']]): Network endpoints for the container.
    """
    ...
    endpoints: Union[Unset, List["EndPointConfig"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for endpoints_item_data in _endpoints or []:
            endpoints_item = EndPointConfig.from_dict(endpoints_item_data)

            endpoints.append(endpoints_item)

        deployment_config_containers_item = cls(
            cmd=cmd,
            env=env,
            image=image,
        ...
        deployment_config_containers_item.additional_properties = d
        return deployment_config_containers_item
